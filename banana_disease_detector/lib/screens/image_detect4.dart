...
class ImageDetect4 extends StatefulWidget {
  final Farmer farmer;
  ImageDetect4({Key? key, required this.farmer}) : super(key: key);

  @override
  _ImageDetectState createState() => _ImageDetectState();
}

class _ImageDetectState extends State<ImageDetect4> {
...
//calculate the distance to disease location
  ...
  Future<void> _predict(File file, double lat, double long) async {
    ...
    Response response = await dio.post(IP + 'detectBanana/', data: formData);
