...
class ImageDetect3 extends StatefulWidget {
  final Farmer farmer;
  ImageDetect3({Key? key, required this.farmer}) : super(key: key);

  @override
  _ImageDetectState createState() => _ImageDetectState();
}

class _ImageDetectState extends State<ImageDetect3> {
...
//calculate the distance to disease location
  ...
  Future<void> _predict(File file, double lat, double long) async {
    ...
    Response response = await dio.post(IP + 'diseaseSigatoka/', data: formData);
